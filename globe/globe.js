...
DAT.Globe = function(container, colorFn) {
  ...
  colorFn = colorFn || function(x, intensity) {
  ...
  var Shaders = {
    'earth' : {
      ...
      fragmentShader: [
        ...
        'void main() {',
          ...
          'float intensity = 0.5 - dot( vNormal, vec3( 0.0, 0.0, 0.0 ) );',
    ...
    'atmosphere' : {
      ...
      fragmentShader: [
        'varying vec3 vNormal;',
        'void main() {',
          'float intensity = pow( 0.1 - dot( vNormal, vec3( 0, 0, 1.0 ) ), 12.0 );',
  ...
  addData = function(data, opts) {
    ...
    if (opts.format === 'magnitude') {
      ...
      step = 4;
      colorFnWrapper = function(data, i) { return colorFn(data[i+3],data[i+3]); }
    } else {
